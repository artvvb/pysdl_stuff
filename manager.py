...
systems = (('Windows','64bit'),('Windows','32bit'))
my_system = (platform.system(), platform.architecture()[0])

if not my_system in systems:
	print('ERROR: unsupported system:', my_system)
	sys.exit()
	
os.environ["PYSDL2_DLL_PATH"] = os.path.join(os.path.dirname(__file__), "lib", my_system[0], my_system[1])
print('Using SDL2 DLL at path:', os.environ["PYSDL2_DLL_PATH"])
...
print('Using resources at path:', os.path.join(os.path.dirname(__file__), "resources"))
